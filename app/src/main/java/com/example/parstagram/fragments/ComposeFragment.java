...
public class ComposeFragment extends Fragment {
    ...
    // This is an arbitrary random number
    ...
    private void launchCamera() {
        ...
        // URI identifies the resource (here, the file representing our image)
        Uri fileProvider = FileProvider.getUriForFile(getContext(),
                                                        "com.codepath.fileprovider", photoFile);
        // Indicate to the application that we launch (Camera app)
        // where we want the application to put our output.
